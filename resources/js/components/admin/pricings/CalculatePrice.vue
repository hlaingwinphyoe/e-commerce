<template>
  <div class="calculate_price-container">
    ...
    <div class="form-group">
      ...
      <div class="input-group input-group mb-3">
        ...
        <div class="input-group-append">
          <select
            class="custom-select custom-select-sm bg-light"
            name="currency"
    ...
    <wastes :wastes="wastes" :statuses="statuses" @on-update-waste="onUpdateWaste"></wastes>

    <div class="form-group" v-if="form.pure_price">
      <label for>Pure Price</label>
      <input
        type="text"
