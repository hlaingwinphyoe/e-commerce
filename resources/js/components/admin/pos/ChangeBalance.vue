                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h5 class="text-primary mb-3">Total Amount - <span class="fw-bold">{{ getSubTotal }}</span></h5>
                                            <div class="form-group">
                                                ...
                                                <small
                                                    class="text-danger"
                                                    v-show="is_subceed"
                                                    >Subceed Minimum</small
                                                >
                                            </div>
                                            <div class="form-group">
                                                <label>Change</label>
                                                <input type="text" v-model="form.change" class="form-control form-control-sm" />
                                            </div>
                                            <ul class="nav mt-3">
                                                <li
                                        ...
                                        <div class="modal-footer">
                                            <button class="btn btn-sm btn-primary" @click.prevent="onMakePayment">
                                                Pay
                                            </button>
                                            <button
                                                type="button"
    ...
    methods: {
        ...
        onInputChange() {
            if (Number(this.form.amount) < this.getBalance) {
                // this.form.amount = this.getBalance;
                this.is_subceed = true;
            } else {
                this.is_subceed = false;
                this.form.change = this.form.amount - this.getBalance;
            }
        },
        onSelectPayment(id) {
