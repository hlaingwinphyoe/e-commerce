...
<div>
    <h3 class="page-title {{App::getLocale() == 'mm' ? 'mm-font' : ''}}">Exchange Rate</h3>
</div>

@include('components.admin.message')

<div class="border bg-white rounded px-2 py-4">
    <p class="me-2"><span class="fw-bold h5">{{ $exchangerates->count() }}</span> of total <span class="">{{ $exchangerates->total() }}</span></p>

    <div class="d-flex mb-3">
        <div class="d-flex flex-wrap mb-2">
            <div class="me-2 mt-2">
                <a href="{{ route('admin.exchangerates.create') }}" class="btn btn-sm btn-secondary">
            ...
            <form action="{{ route('admin.exchangerates.index') }}" class="d-flex responsive-flex align-items-end">
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('admin.exchangerates.index') }}" class="btn btn-sm btn-danger mb-1">
