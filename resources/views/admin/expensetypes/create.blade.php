...
<div>
    ...
    <form action="{{ route('admin.expensetypes.store') }}" method="post">
        @csrf
            ...
            <div class="col-md-6 mb-2">
                <div class="py-3">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="desc" class="form-control form-control-sm" rows="5" placeholder="Description">{{ old('desc') }}</textarea>
                    </div>
                    </div>
            </div>
        </div>
