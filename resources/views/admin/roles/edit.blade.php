            ...
            <div class="col-md-12 mb-2">
                <div class="form-group">
                    <div class="custom-radio custom-control custom-control-inline">
                        <input type="radio" name="type" class="custom-control-input" id="operation" value="Operation" {{ $role->type == 'Operation' ? 'checked' : '' }}>
                        <label for="operation" class="custom-control-label">Operation Role</label>
                    </div>

                    <div class="custom-radio custom-control custom-control-inline">
                        <input type="radio" name="type" class="custom-control-input" id="customer" value="Customer" {{ $role->type == 'Customer' ? 'checked' : '' }}>
