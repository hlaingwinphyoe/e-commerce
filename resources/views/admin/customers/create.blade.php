...
<div>
    <div class="d-flex mb-4 align-items-center">
        <a href="{{ route('admin.customers.index') }}" class="btn btn-primary btn-sm me-2">
            <i class="fa-solid fa-arrow-left"></i>
        </a>
        <h4 class="page-title mb-0 me-2">Customer</h4>
            ...
            <div class="col-md-8 mb-2">
                <div class="py-3">
                    ...
                    <div class="form-group">
                        ...
                        <small class="help-text text-muted">ရှိလျှင်ထည့်ပါ။</small>
                        <textarea name="address" class="form-control form-control-sm" rows="5" placeholder="Address"></textarea>
                    </div>
