...
@section('classes', 'admin admin-discountypes admin-discountypes-create')

@section('content-header')
<x-admin.content-header :navs="['discountypes', 'create']"></x-admin.content-header>
@endsection
...
<div>
    ...
    <form action="{{ route('admin.discountypes.store') }}" method="post">
        @csrf
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        <div class="form-group start-date-container">
                            ...
                            <input type="date" name="start_date" id="start-date" class="form-control form-control-sm date-picker" placeholder="Start Date" value="{{ old('start_date') }}">
                            @error('start_date')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="form-group col-md-6">
                        <div class="form-group end-date-container">
                            ...
                            <input type="date" name="end_date" id="end-date" class="form-control form-control-sm date-picker" placeholder="End Date" value="{{ old('end_date') }}">
                            @error('end_date')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
